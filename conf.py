# -*- coding: utf-8 -*-
#
# PSOA-to-TPTP Converter documentation build configuration file, created by
...
man_pages = [
    ('main', 'psoa-to-tptpconverter', u'PSOA-to-TPTP Converter Documentation',
     [u'Reuben Peter-Paul, Gen Zou'], 1)
]
